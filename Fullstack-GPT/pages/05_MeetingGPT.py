...
if video:
    ...
    with summary_tab:
        ...
        if start:
            ...
            frist_summary_prompt = ChatPromptTemplate.from_template(
                """
                Write a concise summary of the following:
                "{text}"
                Please, make sure to Korean.
                CONCISE SUMMARY:
                """
            )

            first_summary_chain = frist_summary_prompt | llm | StrOutputParser()
            ...
            refine_prompt = ChatPromptTemplate.from_template(
                ...
                and please make sure to Korean.
